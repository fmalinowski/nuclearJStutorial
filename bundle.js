...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storesProductStore = __webpack_require__(3);

	var _storesProductStore2 = _interopRequireDefault(_storesProductStore);

	var _storesCartStore = __webpack_require__(8);
	...
	console.log(_reactor2['default'].evaluate(['products']));

	console.log("fetch products");
	_actions2['default'].fetchProducts();

	console.log("get products related to quantities");
	var aGetter = _reactor2['default'].evaluate([['cart', 'itemQty'], ['products'], function (itemQty, products) {
		return itemQty.map(function (qty, itemId) {
			return toImmutable({
	...
	console.log(_reactor2['default'].evaluate(_getters2['default'].products));

	console.log('user getter `cartProducts`');
	console.log(_reactor2['default'].evaluate(_getters2['default'].cartProducts));

	console.log('user getter `cartTotal`');
	console.log(_reactor2['default'].evaluate(_getters2['default'].cartTotal));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nuclearJsExamplesShoppingCartCommonApiShop = __webpack_require__(10);

	var _nuclearJsExamplesShoppingCartCommonApiShop2 = _interopRequireDefault(_nuclearJsExamplesShoppingCartCommonApiShop);
	...
	exports['default'] = {
		fetchProducts: function fetchProducts() {
			_nuclearJsExamplesShoppingCartCommonApiShop2['default'].getProducts(function (products) {
				debugger;
...
/***/ function(module, exports) {
	...
	var cartProducts = [['cart', 'itemQty'], ['products'], function (itemQty, products) {
		return itemQty.map(function (qty, productId) {
